...
#     # Extract and compute the keypoints and descriptors of the logo image
#     des_logo = sift.detectAndCompute(logo_img, None) 
#     image = cv2.imread(image_filename)
    
#     # Extract and compute the keypoints and descriptors of the target image
...
def detect_logo(logo_filename, image_filename):
    ...
    # Extract and compute the keypoints and descriptors of the logo image
    kp_logo, des_logo = surf.detectAndCompute(logo_img, None)
