...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute bg-primary-50 left-0 top-0 z-9999 flex h-screen w-72 flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0 ${
